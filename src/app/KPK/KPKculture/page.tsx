...
const KPKculture = () => {
    return (
        <div className="background_KPKculture mt-0" >
            ...
            <main className="KPK w-full  justify-center items-center space-between  p-14">

                <br /><br />
                <h1 className="text-4xl justify-start text-white mb-10"><b>KPK Culture</b></h1>
                <div className="flex grid-rows-4">
                    <div className="m-4" id="KPK_imgs1"></div>
                    <div className="m-4" id="KPK_img3"></div>
                    <div className="m-4" id="KPK_imgs2"></div>
                    <div className="m-4" id="KPK_img4"></div>
                </div>
