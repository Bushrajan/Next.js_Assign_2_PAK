  ...
  return (
    <div className="background_Balochistan mt-0" >
      ...
      <div className="herosection max-w-screen-md mt-48">
        ...
        <p className="p1 text-l pl-6 mt-8 mb-12 "> Balochistan derives its name from the Baloch tribes, who gradually migrated and settled in the region from the 5th century onwards. These nomadic tribes established a distinct identity and began to exert their influence, shaping the future trajectory of Balochistans history.</p>
      </div>
