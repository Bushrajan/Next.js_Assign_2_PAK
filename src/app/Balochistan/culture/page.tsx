...
const culture = () => {
    return (
        <div className="background_culture mt-0" >
            ...
            <main className="Balochistan w-full  justify-center items-center space-between  p-14">

                <br /><br />
                <h1 className="text-4xl justify-start text-white mb-10">Balochistan Culture</h1>
                <div className="flex grid-rows-4">
                    <div className="m-4" id="balochistani_img1"></div>
                    <div className="m-4" id="balochistani_imgs3"></div>
                    <div className="m-4" id="balochistani_img2"></div>
                    <div className="m-4" id="balochistani_imgs4"></div>
                </div>
            </main>
